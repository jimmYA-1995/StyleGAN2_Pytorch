...
def get_arguments():
    ...
    parser.add_argument('--num_worker', type=int, default=2, help='num worker of dataloader')
    ...
    parser.add_argument('--skeleton_channels', type=int, default=0, choices=[0, 1, 2, 3])
