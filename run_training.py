...
from models import G_main as Generator
...
if __name__ == '__main__':
    ...
    generator = Generator(args.latent, 0, args.size, is_training=True).to(device)
    discriminator = Discriminator(0, args.size).to(device)
    g_ema = Generator(args.latent, 0, args.size, is_training=False).to(device)
...
#     dataset = MultiResolutionDataset(args.path, transform, args.size)
    print("use ImageFolder dataset...")
    dataset = ImageFolderDataset(args.path, transform, args.size)
